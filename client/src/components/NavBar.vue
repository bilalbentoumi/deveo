<template>
    ...
    <div class="bg-white bg-opacity-90 backdrop-blur border-b fixed left-0 right-0 h-16 flex items-center border-b border-gray-900/10 dark:border-gray-50/[0.06]">

        <div class="max-w-8xl mx-auto px-2 sm:px-6 lg:px-8 w-full grid grid-cols-12 gap-4 items-center">

            <div class="col-span-4 md:col-span-3 lg:col-span-3 xl:col-span-2 flex">
                <a href="" class="logo inline-flex items-center gap-2">
